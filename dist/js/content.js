...
})({"j4rmZ":[function(require,module,exports,__globalThis) {
document.addEventListener('DOMContentLoaded', ()=>{
    alert("DOM is ready!");
});
console.log("Content script is running!"); // chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
